...
#define CUSTOM_MENDEL_NAME "KLD-LCD1260"  //--BH
...
//#define PREVENT_DANGEROUS_EXTRUDE	 //--BH
//if PREVENT_DANGEROUS_EXTRUDE is on, you can still disable (uncomment) very long bits of extrusion separately.
//#define PREVENT_LENGTHY_EXTRUDE  //--BH

#define EXTRUDE_MINTEMP 0  //--BH
...
const bool Z_MAX_ENDSTOP_INVERTING = false; //--BH set to true to invert the logic of the endstop.
...
#define DISABLE_X true  //--BH
#define DISABLE_Y true  //--BH
#define DISABLE_Z false
#define DISABLE_E true //--BH For all extruders
#define DISABLE_INACTIVE_EXTRUDER true //disable only inactive extruders and keep active extruder enabled

#define INVERT_X_DIR false    //--BH for Mendel set to false, for Orca set to true
...
//#define Z_PROBE_REPEATABILITY_TEST  //--BH If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  //#define Z_SAFE_HOMING   //--BH This feature is meant to avoid Z homing with probe outside the bed area.
...
#define HOMING_FEEDRATE {1500, 1500, 125, 300}  //--BH set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 1600, 700}  //--BH default settings for for KLD-LCD1260/2150
#define DEFAULT_MAX_FEEDRATE          {400, 400, 220, 45}  //--BH (mm/sec)
...
#define EEPROM_SETTINGS  //--BH Just like having this option enabled
...
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  //--BH Just testing
